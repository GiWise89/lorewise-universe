...
test("limits card compaction to phones and menu reordering to tablets", async () => {
  ...
  const tabletStart = styles.lastIndexOf("@media (min-width:701px) and (max-width:1100px)");
  const phoneStart = styles.lastIndexOf("@media (max-width:700px)");
  const vipPhoneStart = styles.lastIndexOf("@media (max-width:620px)");
