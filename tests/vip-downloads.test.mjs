...
test("declares six individual VIP packages and two complete collections", () => {
  assert.equal(Object.keys(VIP_DOWNLOAD_PACKAGES).length, 8);
...
test("builds a documented and verifiable ZIP without altering source bytes", async () => {
  const downloadPackage = getVipDownloadPackage("twr-vip-drop-01-completo");
