...
const visualMeta = {
  "first-days": { src: "/atlas/animal-crossing-new-horizons/official/01-primi-giorni.jpg", alt: "Falò e tende sulla spiaggia durante i primi giorni dell'isola", caption: "Il campo iniziale e i primi passi sull'isola · immagine ufficiale Nintendo." },
  economy: { src: "/atlas/animal-crossing-new-horizons/official/02-economia-servizi.jpg", alt: "Tom Nook illustra i servizi e l'ampliamento della casa", caption: "Servizi, casa e progressione economica · immagine ufficiale Nintendo." },
  turnips: { src: "/atlas/animal-crossing-new-horizons/official/03-mercato-rape.jpg", alt: "Brunella propone al giocatore l'acquisto delle rape", caption: "Il mercato delle rape comincia da Brunella · immagine ufficiale Nintendo." },
  "five-stars": { src: "/atlas/animal-crossing-new-horizons/official/04-cinque-stelle-giardinaggio.jpg", alt: "Giocatore che cura un'aiuola fiorita sull'isola", caption: "Fiori, ordine e cura aiutano la valutazione dell'isola · immagine ufficiale Nintendo." },
  design: { src: "/atlas/animal-crossing-new-horizons/official/05-island-designer.jpg", alt: "Percorsi, fiume e ponte modificati con gli strumenti di progettazione", caption: "Percorsi e terraformazione con l'App Designer Isola · immagine ufficiale Nintendo." },
  customization: { src: "/atlas/animal-crossing-new-horizons/official/06-decorazione-personalizzazione.jpg", alt: "Modalità arredamento con mobili e ambienti personalizzati", caption: "Disporre e personalizzare gli ambienti con precisione · immagine ufficiale Nintendo." },
  tools: { src: "/atlas/animal-crossing-new-horizons/official/07-strumenti-oro.jpg", alt: "Giocatore circondato dagli strumenti d'oro e da pepite d'oro", caption: "Gli strumenti d'oro di Animal Crossing: New Horizons, mostrati direttamente nel gioco." },
  patterns: { src: "/atlas/animal-crossing-new-horizons/official/08-modelli-personalizzati.jpg", alt: "Abiti creati con diversi modelli personalizzati", caption: "Modelli personalizzati applicati agli abiti · immagine ufficiale Nintendo." },
  "happy-home": { src: "/atlas/animal-crossing-new-horizons/official/09-happy-home-paradise.png", alt: "Casimira e Gilberti presentano richieste di case vacanza in Happy Home Paradise", caption: "Clienti, desideri e progettazione in Happy Home Paradise · immagine ufficiale Nintendo." },
  "villager-homes": { src: "/atlas/animal-crossing-new-horizons/official/10-case-abitanti.jpg", alt: "Interno arredato della casa di un abitante", caption: "Ogni abitante merita uno spazio riconoscibile · immagine ufficiale Nintendo." },
  hotel: { src: "/atlas/animal-crossing-new-horizons/official/11-hotel.png", alt: "Illustrazione promozionale ufficiale dell'hotel sul molo", caption: "L'hotel sul molo · immagine promozionale ufficiale Nintendo." },
  online: { src: "/atlas/animal-crossing-new-horizons/official/12-online.jpg", alt: "Diversi giocatori riuniti sulla stessa isola", caption: "Visitare e giocare insieme online · immagine ufficiale Nintendo." },
  "sea-creatures": { src: "/atlas/animal-crossing-new-horizons/official/13-creature-marine.jpg", alt: "Giocatore in muta che mostra una stella marina appena raccolta", caption: "Immersioni e raccolta delle creature marine · immagine ufficiale Nintendo." },
  museum: { src: "/atlas/animal-crossing-new-horizons/official/14-museo-blatero.jpg", alt: "Blatero accoglie il giocatore all'interno del museo", caption: "Blatero e le collezioni del museo · immagine ufficiale Nintendo." },
  community: { src: "/atlas/animal-crossing-new-horizons/official/15-community-giocatori.jpg", alt: "Un gruppo di giocatori riunito sulla costa dell'isola al tramonto", caption: "Incontrarsi, visitare altre isole e condividere l'esperienza con la community · immagine ufficiale Nintendo." },
  checklist: { src: "/atlas/animal-crossing-new-horizons/official/16-checklist-miglia.jpg", alt: "App Miglia di Nook con obiettivi e progressi completati", caption: "Obiettivi e progressi da controllare prima di proseguire · immagine ufficiale Nintendo." },
};
...
const sections = [
  {
    ...
    icon: { src: "/atlas/animal-crossing-new-horizons/section-icons/progression-v1.png", alt: "Tenda e casa su una piccola isola", caption: "Inizio e crescita" },
  ...
  },
  {
    ...
    icon: { src: "/atlas/animal-crossing-new-horizons/section-icons/creativity-v1.png", alt: "Tavolo creativo con mappa, colori e fiore", caption: "Isola e creatività" },
  ...
  },
  {
    ...
    icon: { src: "/atlas/animal-crossing-new-horizons/section-icons/homes-v1.png", alt: "Casa e piccola struttura per gli ospiti su un'isola", caption: "Case e servizi" },
  ...
  },
  {
    ...
    icon: { src: "/atlas/animal-crossing-new-horizons/section-icons/collections-v1.png", alt: "Cartoline di isole collegate e collezione marina", caption: "Online e collezioni" },
  ...
  },
  {
    ...
    icon: { src: "/atlas/animal-crossing-new-horizons/section-icons/community-v1.png", alt: "Bacheca dell'isola con mappa e lista completata", caption: "Community e verifica" },
