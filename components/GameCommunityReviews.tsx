...
type Review = { id: string; author: string; membershipBadge: string | null; familiarBadge: string | null; body: string; rating: number; version: string; createdAt: string; edited: boolean; ownedByViewer: boolean };
