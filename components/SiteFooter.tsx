  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid">
        ...
        <div className="footer-column"><h2>Tutela e assistenza</h2><ul><li><Link className="footer-app-link" href="/download-app">Scarica l'app Android</Link></li><li><Link href="/contatti">Contatti e informazioni</Link></li><li><Link href="/assistenza-giochi">Assistenza giochi</Link></li><li><Link href="/contatti#social">Canali social</Link></li><li><Link href="/arte#protezione">Protezione delle opere</Link></li><li><Link href="/licenza-arte">Licenza personale Arte</Link></li><li><Link href="/commissioni/condizioni">Condizioni commissioni</Link></li><li><Link href="/condizioni-vendita-giochi">Condizioni giochi digitali</Link></li><li><Link href="/privacy">Privacy e dati</Link></li></ul></div>
      </div>
