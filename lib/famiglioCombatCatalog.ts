...
// HP, attacco e difesa (base e crescita) sono tarati sui duelli liberi a pari
// livello (scripts/fuzz-famiglio-combat.mjs --rarity, giocatore "avido" contro
// l'IA): la rarità resta un vantaggio ma non schiacciante. Obiettivi medi per
// rarità: comune 35-50%, raro 45-60%, epico 55-70%, leggendario 65-80%, e
// nessuna specie sotto il 30% o sopra l'85%. Anche il ruolo pesa: a parità di
// rarità i "sostegno" (che si curano) e i "colosso" (+6% HP e Impatto
// titanico) hanno numeri più contenuti, gli "agile", che scambiano HP per una
// velocità che vale poco, ne hanno di più. La velocità non è stata toccata. Controllo: tests/famiglio-combat-rarity-balance.test.mjs.
const SPECIES: readonly SpeciesSeed[] = [
  { id: "cat", rarity: "comune", affinity: "vento", role: "agile", baseStats: { hp: 101, attack: 29, defense: 23, speed: 31 }, growth: { hp: 5.31, attack: 1.53, defense: 1.13, speed: 1.48 }, techniques: ["Balzo felino", "Artiglio di velluto", "Coda imprevedibile", "Nove slanci", "Regno del tetto"] },
  { id: "golden", rarity: "comune", affinity: "natura", role: "sostegno", baseStats: { hp: 92, attack: 19, defense: 23, speed: 22 }, growth: { hp: 5.03, attack: 0.96, defense: 1.13, speed: 1.05 }, techniques: ["Corsa gioiosa", "Zampa leale", "Riporto luminoso", "Abbraccio dorato", "Patto del branco"] },
  { id: "akita", rarity: "comune", affinity: "vento", role: "assaltatore", baseStats: { hp: 102, attack: 30, defense: 24, speed: 25 }, growth: { hp: 5.36, attack: 1.54, defense: 1.21, speed: 1.21 }, techniques: ["Passo dell'Akita", "Morso vigile", "Scatto cremisi", "Fedeltà incrollabile", "Giuramento del monte"] },
  { id: "great-dane", rarity: "raro", affinity: "antico", role: "guardiano", baseStats: { hp: 121, attack: 29, defense: 35, speed: 18 }, growth: { hp: 6.36, attack: 1.32, defense: 1.61, speed: 0.83 }, techniques: ["Passo imponente", "Spallata gentile", "Guardia dell'Alano", "Ruggito profondo", "Baluardo regale"] },
  { id: "schnauzer", rarity: "comune", affinity: "natura", role: "agile", baseStats: { hp: 87, attack: 25, defense: 23, speed: 29 }, growth: { hp: 4.6, attack: 1.22, defense: 1.13, speed: 1.39 }, techniques: ["Baffo saettante", "Zampata precisa", "Fiuto del sentiero", "Scatto barbuto", "Sentinella d'argento"] },
  { id: "saint-bernard", rarity: "raro", affinity: "marea", role: "sostegno", baseStats: { hp: 112, attack: 22, defense: 33, speed: 17 }, growth: { hp: 5.98, attack: 0.98, defense: 1.48, speed: 0.78 }, techniques: ["Soccorso alpino", "Zampa protettrice", "Botte del ristoro", "Abbraccio di neve", "Salvezza del San Bernardo"] },
  { id: "husky", rarity: "comune", affinity: "marea", role: "agile", baseStats: { hp: 105, attack: 29, defense: 25, speed: 29 }, growth: { hp: 5.47, attack: 1.45, defense: 1.21, speed: 1.4 }, techniques: ["Corsa sulla neve", "Morso boreale", "Ululato polare", "Slitta impetuosa", "Branco dell'aurora"] },
  { id: "rabbit", rarity: "comune", affinity: "natura", role: "agile", baseStats: { hp: 91, attack: 24, defense: 21, speed: 33 }, growth: { hp: 4.68, attack: 1.26, defense: 1.12, speed: 1.56 }, techniques: ["Balzo del prato", "Calcio rapido", "Orecchie vigili", "Zigzag di trifoglio", "Primavera senza fine"] },
  { id: "fox", rarity: "comune", affinity: "ardore", role: "agile", baseStats: { hp: 99, attack: 31, defense: 21, speed: 32 }, growth: { hp: 5.01, attack: 1.56, defense: 1.08, speed: 1.5 }, techniques: ["Scatto fulvo", "Coda di brace", "Finta della volpe", "Morso crepuscolare", "Danza delle nove scintille"] },
  { id: "turtle", rarity: "comune", affinity: "marea", role: "guardiano", baseStats: { hp: 125, attack: 23, defense: 37, speed: 14 }, growth: { hp: 6.77, attack: 1.16, defense: 1.91, speed: 0.71 }, techniques: ["Urto del guscio", "Ritirata sicura", "Rotazione marina", "Passo millenario", "Fortezza delle maree"] },
  { id: "panda", rarity: "raro", affinity: "natura", role: "guardiano", baseStats: { hp: 103, attack: 24, defense: 29, speed: 18 }, growth: { hp: 5.44, attack: 1.1, defense: 1.38, speed: 0.86 }, techniques: ["Rotolo di bambù", "Palmo tranquillo", "Merenda tenace", "Abbraccio possente", "Santuario del bambù"] },
  { id: "horse", rarity: "raro", affinity: "vento", role: "assaltatore", baseStats: { hp: 111, attack: 31, defense: 25, speed: 30 }, growth: { hp: 5.69, attack: 1.51, defense: 1.17, speed: 1.37 }, techniques: ["Galoppo libero", "Zoccolo tonante", "Criniera al vento", "Carica del destriero", "Corsa oltre l'orizzonte"] },
  { id: "polar-bear", rarity: "raro", affinity: "marea", role: "colosso", baseStats: { hp: 115, attack: 30, defense: 29, speed: 16 }, growth: { hp: 6.09, attack: 1.37, defense: 1.33, speed: 0.74 }, techniques: ["Zampa glaciale", "Ruggito artico", "Morsa della banchisa", "Valanga bianca", "Re del polo"] },
  { id: "brown-bear", rarity: "raro", affinity: "natura", role: "colosso", baseStats: { hp: 100, attack: 28, defense: 24, speed: 17 }, growth: { hp: 5.24, attack: 1.23, defense: 1.12, speed: 0.79 }, techniques: ["Zampa del bosco", "Morso del miele", "Abbraccio selvatico", "Furia del letargo", "Cuore della foresta"] },
  { id: "parrot", rarity: "comune", affinity: "vento", role: "mistico", baseStats: { hp: 103, attack: 29, defense: 22, speed: 30 }, growth: { hp: 5.29, attack: 1.54, defense: 1.14, speed: 1.45 }, techniques: ["Becco variopinto", "Eco perfetta", "Piume abbaglianti", "Volo tropicale", "Coro dei cinque cieli"] },
  { id: "bird", rarity: "comune", affinity: "vento", role: "agile", baseStats: { hp: 103, attack: 28, defense: 23, speed: 35 }, growth: { hp: 5.32, attack: 1.41, defense: 1.12, speed: 1.62 }, techniques: ["Beccata rapida", "Ala leggera", "Canto del mattino", "Picchiata colorata", "Stormo dell'arcobaleno"] },
  { id: "chicken", rarity: "comune", affinity: "natura", role: "sostegno", baseStats: { hp: 92, attack: 21, defense: 22, speed: 23 }, growth: { hp: 4.94, attack: 1.05, defense: 1.14, speed: 1.1 }, techniques: ["Beccata campestre", "Ala protettiva", "Richiamo del pulcino", "Corsa nel pollaio", "Alba della covata"] },
  { id: "wolf", rarity: "raro", affinity: "arcano", role: "assaltatore", baseStats: { hp: 106, attack: 32, defense: 25, speed: 29 }, growth: { hp: 5.38, attack: 1.54, defense: 1.16, speed: 1.35 }, techniques: ["Morso lunare", "Caccia silenziosa", "Ululato del Nexus", "Balzo del branco", "Luna del capobranco"] },

  { id: "fairy-rabbit", rarity: "raro", affinity: "arcano", role: "sostegno", baseStats: { hp: 94, attack: 29, defense: 23, speed: 32 }, growth: { hp: 4.83, attack: 1.39, defense: 1.15, speed: 1.46 }, techniques: ["Balzo fatato", "Polvere di trifoglio", "Orecchie incantate", "Portale del prato", "Desiderio della radura"] },
  { id: "demon-rabbit", rarity: "raro", affinity: "ardore", role: "assaltatore", baseStats: { hp: 103, attack: 37, defense: 22, speed: 31 }, growth: { hp: 5.17, attack: 1.78, defense: 1.11, speed: 1.41 }, techniques: ["Calcio infernale", "Orecchie di brace", "Balzo maledetto", "Morso cremisi", "Eclissi del coniglio"] },
  { id: "faerie-dragon", rarity: "epico", affinity: "arcano", role: "mistico", baseStats: { hp: 104, attack: 36, defense: 25, speed: 34 }, growth: { hp: 5.14, attack: 1.65, defense: 1.2, speed: 1.5 }, techniques: ["Morso di fata", "Scaglie iridescenti", "Spirale incantata", "Soffio prismico", "Aurora del drago fatato"] },
  { id: "blue-wyrmling", rarity: "epico", affinity: "marea", role: "assaltatore", baseStats: { hp: 106, attack: 36, defense: 27, speed: 27 }, growth: { hp: 5.43, attack: 1.64, defense: 1.27, speed: 1.23 }, techniques: ["Morso azzurro", "Soffio di marea", "Coda del vortice", "Ruggito della risacca", "Tempesta del giovane drago"] },
  { id: "young-green-dragon", rarity: "epico", affinity: "natura", role: "guardiano", baseStats: { hp: 100, attack: 28, defense: 30, speed: 24 }, growth: { hp: 5.05, attack: 1.27, defense: 1.38, speed: 1.08 }, techniques: ["Artiglio verde", "Scaglia di giada", "Soffio di spore", "Coda rampicante", "Dominio della foresta draconica"] },
  { id: "owlbear", rarity: "epico", affinity: "antico", role: "colosso", baseStats: { hp: 110, attack: 33, defense: 30, speed: 19 }, growth: { hp: 5.7, attack: 1.49, defense: 1.32, speed: 0.86 }, techniques: ["Becco dell'orsogufo", "Artiglio selvaggio", "Abbraccio piumato", "Ruggito notturno", "Predatore della luna antica"] },
  { id: "griffin", rarity: "epico", affinity: "vento", role: "assaltatore", baseStats: { hp: 103, attack: 35, defense: 26, speed: 34 }, growth: { hp: 5.19, attack: 1.62, defense: 1.19, speed: 1.48 }, techniques: ["Artiglio del grifone", "Becco regale", "Picchiata solare", "Ala maestosa", "Sovrano dei cieli"] },
  { id: "elder-snail", rarity: "raro", affinity: "antico", role: "guardiano", baseStats: { hp: 120, attack: 27, defense: 41, speed: 10 }, growth: { hp: 6.46, attack: 1.22, defense: 1.83, speed: 0.48 }, techniques: ["Scia ancestrale", "Guscio runico", "Antenne veggenti", "Spirale del tempo", "Era della lumaca"] },
  { id: "fiddle-dog", rarity: "comune", affinity: "arcano", role: "sostegno", baseStats: { hp: 101, attack: 24, defense: 23, speed: 24 }, growth: { hp: 5.37, attack: 1.22, defense: 1.19, speed: 1.14 }, techniques: ["Archetto allegro", "Nota saltellante", "Ritornello fedele", "Cadenza del cucciolo", "Sinfonia del branco"] },
  { id: "guardian-rabbit", rarity: "raro", affinity: "arcano", role: "guardiano", baseStats: { hp: 106, attack: 29, defense: 37, speed: 27 }, growth: { hp: 5.43, attack: 1.3, defense: 1.66, speed: 1.22 }, techniques: ["Scudo del coniglio", "Calcio della soglia", "Sigillo delle orecchie", "Balzo sentinella", "Porta inviolabile"] },
  { id: "slime", rarity: "raro", affinity: "marea", role: "sostegno", baseStats: { hp: 108, attack: 25, defense: 29, speed: 16 }, growth: { hp: 5.86, attack: 1.16, defense: 1.38, speed: 0.8 }, techniques: ["Rimbalzo gelatinoso", "Bolla adesiva", "Divisione elastica", "Abbraccio fluido", "Marea dello slime"] },
  { id: "kappa", rarity: "raro", affinity: "marea", role: "guardiano", baseStats: { hp: 113, attack: 30, defense: 38, speed: 20 }, growth: { hp: 5.99, attack: 1.39, defense: 1.73, speed: 0.93 }, techniques: ["Palmo del kappa", "Piatto colmo", "Tuffo del fiume", "Presa del canneto", "Custode delle acque"] },
  { id: "nexus-bat", rarity: "raro", affinity: "arcano", role: "agile", baseStats: { hp: 101, attack: 35, defense: 22, speed: 37 }, growth: { hp: 5, attack: 1.63, defense: 1.09, speed: 1.65 }, techniques: ["Morso del Nexus", "Eco stellare", "Ala d'ombra", "Volo interdimensionale", "Notte tra i mondi"] },
  { id: "frost-salamander", rarity: "raro", affinity: "marea", role: "mistico", baseStats: { hp: 101, attack: 35, defense: 26, speed: 25 }, growth: { hp: 5.18, attack: 1.59, defense: 1.24, speed: 1.16 }, techniques: ["Morso di brina", "Coda gelida", "Passo sul ghiaccio", "Respiro invernale", "Cuore dello zero"] },

  { id: "adult-red-dragon", rarity: "leggendario", affinity: "ardore", role: "colosso", baseStats: { hp: 114, attack: 36, defense: 29, speed: 27 }, growth: { hp: 5.7, attack: 1.54, defense: 1.28, speed: 1.13 }, techniques: ["Artiglio cremisi", "Soffio vulcanico", "Coda della fornace", "Ruggito del magma", "Apocalisse del drago rosso"] },
  { id: "ancient-black-dragon", rarity: "leggendario", affinity: "antico", role: "mistico", baseStats: { hp: 112, attack: 35, defense: 32, speed: 25 }, growth: { hp: 5.5, attack: 1.48, defense: 1.33, speed: 1.08 }, techniques: ["Artiglio d'ossidiana", "Soffio del vuoto", "Scaglia millenaria", "Eclissi corrosiva", "Fine dell'era antica"] },
  { id: "displacer-beast", rarity: "leggendario", affinity: "arcano", role: "agile", baseStats: { hp: 108, attack: 36, defense: 26, speed: 43 }, growth: { hp: 5.25, attack: 1.56, defense: 1.15, speed: 1.82 }, techniques: ["Tentacolo dislocante", "Passo irreale", "Immagine residua", "Balzo tra gli spazi", "Predatore impossibile"] },
  { id: "ice-golem", rarity: "leggendario", affinity: "marea", role: "guardiano", baseStats: { hp: 131, attack: 34, defense: 42, speed: 13 }, growth: { hp: 6.57, attack: 1.38, defense: 1.75, speed: 0.57 }, techniques: ["Pugno di ghiaccio", "Parete glaciale", "Nucleo congelato", "Frana di cristallo", "Fortezza dello zero"] },
  { id: "hellhound", rarity: "leggendario", affinity: "ardore", role: "assaltatore", baseStats: { hp: 110, attack: 39, defense: 27, speed: 36 }, growth: { hp: 5.41, attack: 1.64, defense: 1.18, speed: 1.5 }, techniques: ["Morso infernale", "Corsa sulfurea", "Catena di fiamme", "Ululato dannato", "Caccia dell'ultimo fuoco"] },
  { id: "imp", rarity: "leggendario", affinity: "ardore", role: "agile", baseStats: { hp: 108, attack: 37, defense: 27, speed: 44 }, growth: { hp: 5.25, attack: 1.64, defense: 1.12, speed: 1.86 }, techniques: ["Graffio dell'imp", "Scherzo di brace", "Volo malizioso", "Trappola cremisi", "Caos in miniatura"] },
  { id: "beholder", rarity: "leggendario", affinity: "arcano", role: "mistico", baseStats: { hp: 115, attack: 40, defense: 30, speed: 23 }, growth: { hp: 5.62, attack: 1.68, defense: 1.24, speed: 0.99 }, techniques: ["Morso centrale", "Raggio esitante", "Occhio dominante", "Corona di raggi", "Sguardo che spezza il Nexus"] },
  { id: "bulette", rarity: "leggendario", affinity: "antico", role: "colosso", baseStats: { hp: 117, attack: 33, defense: 34, speed: 20 }, growth: { hp: 5.86, attack: 1.43, defense: 1.44, speed: 0.83 }, techniques: ["Morso della bulette", "Tuffo sotterraneo", "Corazza vivente", "Eruzione del terreno", "Terremoto divoratore"] },
  { id: "purple-worm", rarity: "leggendario", affinity: "antico", role: "colosso", baseStats: { hp: 120, attack: 36, defense: 31, speed: 16 }, growth: { hp: 6.07, attack: 1.54, defense: 1.31, speed: 0.68 }, techniques: ["Morso purpureo", "Coda abissale", "Galleria vorace", "Morsa del sottosuolo", "Divoratore delle profondità"] },

  { id: "tyrannosaurus", rarity: "epico", affinity: "antico", role: "colosso", baseStats: { hp: 110, attack: 35, defense: 28, speed: 21 }, growth: { hp: 5.65, attack: 1.52, defense: 1.23, speed: 0.9 }, techniques: ["Morso tiranno", "Passo sismico", "Coda regale", "Ruggito del Cretaceo", "Re dell'era perduta"] },
  { id: "triceratops", rarity: "epico", affinity: "natura", role: "guardiano", baseStats: { hp: 101, attack: 27, defense: 32, speed: 19 }, growth: { hp: 5.18, attack: 1.18, defense: 1.4, speed: 0.81 }, techniques: ["Corno frontale", "Collare fortificato", "Carica triplice", "Terra difesa", "Bastione del Triceratopo"] },
  { id: "velociraptor", rarity: "raro", affinity: "vento", role: "agile", baseStats: { hp: 98, attack: 36, defense: 22, speed: 39 }, growth: { hp: 4.91, attack: 1.66, defense: 1.07, speed: 1.72 }, techniques: ["Artiglio ricurvo", "Caccia coordinata", "Scatto del raptor", "Finta preistorica", "Assalto del branco perduto"] },
  { id: "stegosaurus", rarity: "epico", affinity: "natura", role: "guardiano", baseStats: { hp: 102, attack: 27, defense: 34, speed: 15 }, growth: { hp: 5.24, attack: 1.17, defense: 1.47, speed: 0.65 }, techniques: ["Coda spinata", "Placche solari", "Passo del giurassico", "Spazzata dorsale", "Fortezza dello Stegosauro"] },
  { id: "brachiosaurus", rarity: "epico", affinity: "natura", role: "sostegno", baseStats: { hp: 106, attack: 24, defense: 30, speed: 13 }, growth: { hp: 5.51, attack: 1, defense: 1.23, speed: 0.56 }, techniques: ["Passo del gigante", "Collo svettante", "Richiamo della chioma", "Ombra protettiva", "Cielo del Brachiosauro"] },
  { id: "ankylosaurus", rarity: "epico", affinity: "antico", role: "guardiano", baseStats: { hp: 119, attack: 32, defense: 41, speed: 14 }, growth: { hp: 6.07, attack: 1.4, defense: 1.74, speed: 0.6 }, techniques: ["Mazza caudale", "Piastre ancestrali", "Urto corazzato", "Cerchio difensivo", "Fortezza dell'Anchilosauro"] },
  { id: "spinosaurus", rarity: "epico", affinity: "marea", role: "assaltatore", baseStats: { hp: 112, attack: 36, defense: 28, speed: 27 }, growth: { hp: 5.63, attack: 1.56, defense: 1.23, speed: 1.16 }, techniques: ["Morso dello spinosauro", "Vela della corrente", "Coda palustre", "Caccia anfibia", "Dominio dei due mondi"] },
  { id: "parasaurolophus", rarity: "raro", affinity: "vento", role: "sostegno", baseStats: { hp: 103, attack: 27, defense: 29, speed: 25 }, growth: { hp: 5.23, attack: 1.17, defense: 1.28, speed: 1.16 }, techniques: ["Cresta risonante", "Corsa del branco", "Richiamo fossile", "Eco della valle", "Canto del Parasaurolofo"] },
  { id: "pteranodon", rarity: "epico", affinity: "vento", role: "agile", baseStats: { hp: 105, attack: 39, defense: 23, speed: 42 }, growth: { hp: 5.18, attack: 1.68, defense: 1.08, speed: 1.8 }, techniques: ["Becco del cielo", "Ala fossile", "Picchiata oceanica", "Volo del Cretaceo", "Orizzonte del Pteranodonte"] },
  { id: "dilophosaurus", rarity: "epico", affinity: "ardore", role: "mistico", baseStats: { hp: 102, attack: 38, defense: 24, speed: 35 }, growth: { hp: 5.05, attack: 1.66, defense: 1.1, speed: 1.51 }, techniques: ["Morso crestato", "Velo abbagliante", "Sibilo ardente", "Doppia fiamma", "Corona del Dilofosauro"] },
  { id: "carnotaurus", rarity: "epico", affinity: "ardore", role: "assaltatore", baseStats: { hp: 106, attack: 38, defense: 26, speed: 32 }, growth: { hp: 5.33, attack: 1.65, defense: 1.14, speed: 1.38 }, techniques: ["Corno del Carnotauro", "Morso infuocato", "Carica scarlatta", "Caccia fulminea", "Furia delle corna cremisi"] },
  { id: "pachycephalosaurus", rarity: "raro", affinity: "antico", role: "assaltatore", baseStats: { hp: 100, attack: 31, defense: 31, speed: 22 }, growth: { hp: 5.19, attack: 1.44, defense: 1.39, speed: 1.0 }, techniques: ["Testata fossile", "Cupola resistente", "Rincorsa del Pachicefalo", "Urto delle ere", "Impatto del cranio antico"] },
] as const;
