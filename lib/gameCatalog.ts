...
export const gameProjects: GameProjectRecord[] = [
  ...
  },
  {
    ...
    summary: "Un sandbox divino in pixel art: crei il mondo, posi i primi abitanti di Umani, Elfi, Nani e Orchi, e guardi famiglie, villaggi e guerre nascere da soli. Tu intervieni con i tuoi poteri, quando e come vuoi.",
    description: [
    ...
    features: [
      ...
      "Quattro popoli: Umani, Elfi, Nani e Orchi, con case e armi proprie",
      "Abitanti con nome, aspetto, bisogni, famiglie, figli ed emozioni visibili",
      "Villaggi che costruiscono, coltivano, allevano e traslocano da soli",
      ...
      "In arrivo: dungeon esplorabili, fede, cronaca del mondo e sette ere",
    ],
    releaseArchive: [],
    developmentRoadmap: [],
