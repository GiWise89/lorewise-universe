...
export const gameProjects: GameProjectRecord[] = [
  ...
  },
  {
    ...
    summary: "Un sandbox divino in pixel art: crei il mondo, posi i primi abitanti di sei popoli e guardi famiglie, villaggi, ere e guerre nascere da soli. Tu intervieni con i tuoi poteri, quando e come vuoi.",
    description: [
    ...
    features: [
      ...
      "In arrivo: fede e preghiere, Githyanki e Tiefling, oggetti leggendari",
    ],
    releaseArchive: [],
    developmentRoadmap: [],
