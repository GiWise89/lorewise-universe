...
export const gameProjects: GameProjectRecord[] = [
  ...
  },
  {
    ...
    code: "GS-GAME-004",
    title: "SandBox",
    subtitle: "Crea un mondo. Guarda nascere la sua storia.",
    studio: "GiWise Studio",
    status: "In sviluppo",
    statusTone: "development",
    kind: "Simulatore di mondi in pixel art",
    version: "Prototipo in sviluppo",
    languages: ["Italiano"],
    platforms: ["Browser · computer", "Browser · telefono e tablet"],
    access: "Sviluppo interno · anteprime nel dossier",
    price: "Da annunciare",
    heroImage: "/games/sandbox/mondo-biomi-v1.webp",
    heroAlt: "Un continente di SandBox visto dall’alto, con sei villaggi, biomi diversi, montagne innevate, fiumi e foreste di cristallo in pixel art",
    catalogCoverImage: "/games/sandbox/mondo-biomi-v1.webp",
    logoImage: "/games/sandbox/logo-prima-terra-v2.webp",
    catalogCoverAlt: "Continente in pixel art di SandBox con praterie, foreste, deserti rossi e una foresta di cristalli",
    summary: "Un sandbox in pixel art in cui plasmi terre, mari e montagne, affidi il mondo a sei popoli e osservi famiglie, villaggi e regni crescere da soli, dalle prime capanne fino all’era moderna.",
    description: [
      "SandBox parte da un’idea semplice e immensa: dare al giocatore un mondo intero e lasciare che siano i suoi abitanti a scriverne la storia. Disegni continenti e isole, sollevi montagne, apri fiumi e scegli dove far sbarcare i primi fondatori.",
      "Da quel momento nessuno recita un copione. Ogni abitante ha un nome, un carattere e dei bisogni; si innamora, mette su famiglia, impara un mestiere, costruisce la propria casa. I villaggi diventano città, le città regni, e i regni stringono alleanze, commerciano o si dichiarano guerra.",
      "Tu resti sopra a tutto, come un custode curioso: puoi limitarti a guardare, dare una mano a una civiltà in difficoltà o scatenare terremoti, meteore ed eruzioni per vedere come reagiranno.",
    ],
    features: [
      "Mondi generati con continenti, isole e arcipelaghi sempre diversi",
      "Terreno da plasmare liberamente: mari, fiumi, colline, montagne, lava e acido",
      "Ventidue biomi, dalle praterie alle foreste di cristallo e ai boschi di funghi giganti",
      "Sei popoli giocabili: Umani, Elfi, Nani, Orchi, Githyanki e Tiefling",
      "Abitanti con nomi, caratteri, bisogni, famiglie e figli",
      "Villaggi che crescono da soli, con mestieri, campi, miniere, fucine, templi e mura",
      "Regni con confini, capi, eserciti, alleanze, rivalità e guerre motivate",
      "Stagioni, meteo, giorno e notte, animali selvatici e creature rare",
      "Poteri del creatore: meteore, terremoti, eruzioni e visite inattese dal cielo",
      "Sette ere da attraversare, dalle Origini alla civiltà moderna",
    ],
    releaseArchive: [],
    developmentRoadmap: [],
    releasePlan: "Il dossier crescerà insieme al mondo: nuove immagini e nuove scoperte verranno condivise man mano che le civiltà di SandBox avanzeranno verso le ere successive.",
    commercialNote: "SandBox è in sviluppo attivo. Modalità di accesso e disponibilità saranno annunciate quando il mondo sarà pronto ad accogliere i primi giocatori.",
    updateNote: "Il mondo di SandBox cresce ogni settimana.",
    knownIssues: [],
    mediaNote: "Le immagini provengono dal prototipo in sviluppo e mostrano mondi, villaggi e popoli reali del gioco.",
  },
];
