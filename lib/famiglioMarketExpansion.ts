...
export const PREMIUM_COVERS: readonly PremiumCover[] = [
  ...
  { id: "lunar-micro", name: "Cielo Lunare", description: "Micromotivo di lune, stelle e perle su indaco profondo.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-lunare-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-lunare-v1.webp" },
  { id: "creepy-micro", name: "Piccoli Presagi", description: "Micromotivo creepy con teschi, pipistrelli, candele e occhi.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-creepy-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-creepy-v1.webp" },
  { id: "prism-micro", name: "Prisma Stellare", description: "Micromotivo multicolore di prismi iridescenti e scintille.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-prisma-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-prisma-v1.webp" },
  { id: "sakura-micro", name: "Sakura Cremisi", description: "Micromotivo giapponese di sakura, petali e piccole onde.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-sakura-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-sakura-v1.webp" },
  { id: "emoticon-micro", name: "Emozioni del Nexus", description: "Micromotivo di faccine, cuori, fumetti e stelle colorate.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-emoticon-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-emoticon-v1.webp" },
  { id: "mycelium-micro", name: "Micelio Luminoso", description: "Micromotivo di funghi bioluminescenti, spore e felci.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-micelio-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-micelio-v1.webp" },
  { id: "gothic-rose-micro", name: "Rose Gotiche", description: "Micromotivo di rose bordeaux, spine nere e stelle d'argento.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-rose-gotiche-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-rose-gotiche-v1.webp" },
  { id: "alchemy-micro", name: "Alchimia Segreta", description: "Micromotivo di ampolle, glifi alchemici e gocce cristalline.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-alchimia-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-alchimia-v1.webp" },
  { id: "clockwork-micro", name: "Orologeria Astrale", description: "Micromotivo di ingranaggi, lancette e costellazioni dorate.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-orologeria-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-orologeria-v1.webp" },
  { id: "neon-tropical-micro", name: "Giungla Neon", description: "Micromotivo acceso di ibisco rosa, foglie lime e lucciole ciano.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-neon-tropicale-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-neon-tropicale-v1.webp" },
  { id: "candy-pop-micro", name: "Caramelle Pop", description: "Micromotivo brillante di dolci, cuori e stelle dai colori saturi.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-caramelle-pop-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-caramelle-pop-v1.webp" },
  { id: "solar-citrus-micro", name: "Agrumi Solari", description: "Micromotivo vivido di agrumi, fiori bianchi e scintille turchesi.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-agrumi-solari-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-agrumi-solari-v1.webp" },
  { id: "electric-ocean-micro", name: "Oceano Elettrico", description: "Micromotivo neon di coralli, conchiglie e piccoli pesci tropicali.", artDesktop: "/famiglio/rebuild/market/medusa-pattern-oceano-elettrico-v1.webp", artMobile: "/famiglio/rebuild/market/medusa-pattern-oceano-elettrico-v1.webp" },
