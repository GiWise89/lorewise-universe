...
export const FAMILIAR_GUIDES: Readonly<Record<FamiliarGuideSection, FamiliarSectionGuide>> = {
  ...
  care: {
    ...
    pages: [
      ...
      { title: "Azioni e Zaino", summary: "Puoi avviare una nuova cura solo quando quella in corso è terminata.", points: ["Nutri e Pulisci consumano le scorte corrispondenti", "Gioca e Pulisci richiedono Energia", "Nutri, Coccola e Fai riposare non consumano Energia"] },
  ...
  adventure: {
    ...
    pages: [
      ...
      { title: "Imprevisti del viaggio", summary: "Durante alcune spedizioni compare una scelta chiara con effetti diversi.", points: ["Leggi entrambe le conseguenze", "La scelta viene salvata", "Le ricompense arrivano al rientro"] },
    ],
  },
  combat: {
    id: "combat",
    ...
    pages: [
      ...
      { title: "Iniziativa e turni", summary: "All'inizio entrambi lanciano due dadi: il totale più alto agisce per primo e un doppio attiva il critico d'iniziativa.", points: ["Il tiro avviene una sola volta per battaglia", "Scegli una mossa a ogni turno", "HP a zero conclude immediatamente lo scontro"] },
  ...
  progression: {
    ...
    iconSrc: "/famiglio/rebuild/inventory/bond-lantern.png",
    pages: [
      { title: "Tre cammini collegati", summary: "Crescita, mosse e ricompense mostrano ciò che hai ottenuto e il prossimo requisito.", points: ["Legame: XP, evoluzioni e costanza", "Mosse: livello di lotta e tecniche", "Ricompense: bonus e sconti fino al livello 50"] },
