...
const openingChronicle: NexusChronicle = {
    ...
    signals: [
      ...
      {
        label: "Il Patto delle Ceneri",
        title: "Un nuovo Patto si oppone alla Corte del Rogo.",
        text: "Forma una compagnia, esplora un mondo segnato dalla Ferita e affronta battaglie a turni in cui Valisandra e Vahrokh cambiano le regole dello scontro.",
        image: "/games/the-wound-remembers-il-patto-delle-ceneri/key-art-v2.webp",
        imageAlt: "I protagonisti e i nemici del Patto delle Ceneri",
        note: "GDR tattico dark fantasy · in lavorazione",
        href: "/giochi/the-wound-remembers-il-patto-delle-ceneri",
        action: "Apri il dossier di sviluppo",
      },
    ],
    promotion: {
      theme: "opening",
    ...
    upcoming: {
      ...
      previews: [
        ...
        },
        {
          ...
          image: "/games/the-wound-remembers-il-patto-delle-ceneri/key-art-v2.webp",
          imageAlt: "Il mondo e i personaggi del Patto delle Ceneri",
    ...
    transparency: "Le opere pubbliche e il Codex consultabile non vengono sottratti ai visitatori. Il Pass serve ad approfondire, partecipare e sostenere lo sviluppo: non a nascondere ciò che prima era gratuito.",
    href: "/abbonamento",
...
export const nexusChronicles: NexusChronicle[] = [
  ...
  makeWeeklyChronicle({
    ...
    signals: [
      ...
      {
        label: "Il Patto delle Ceneri",
        title: "Un Rifugio, una compagnia, un nuovo nemico.",
        text: "Il dossier racconta ciò che potrai fare: preparare il Patto, esplorare, scegliere come agire e affrontare scontri a turni contro la Corte del Rogo.",
        image: "/games/the-wound-remembers-il-patto-delle-ceneri/key-art-v2.webp",
        imageAlt: "I protagonisti e i nemici del Patto delle Ceneri",
        note: "Nuovo dossier · progetto in lavorazione",
        href: "/giochi/the-wound-remembers-il-patto-delle-ceneri",
        action: "Apri il dossier",
      },
    ],
    promotion: {
