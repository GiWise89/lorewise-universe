...
export const reinterpretationStories: CreativeJournalEntry[] = [
  ...
  },
  {
    ...
    processImages: [wip("lw-wip-004-preview.webp", "Fotografia protetta della reinterpretazione di Bulma durante la lavorazione", 1200)],
  ...
  },
  {
    ...
    processImages: [wip("lw-wip-006-preview.webp", "Fotografia protetta della reinterpretazione di Pennywise durante la lavorazione")],
  ...
  },
  {
    ...
    processImages: [wip("lw-wip-003-preview.webp", "Fotografia protetta della reinterpretazione di Batwoman durante la lavorazione", 900)],
...
export const studioSketches: CreativeJournalEntry[] = [
  {
    ...
    processImages: [wip("lw-wip-002-preview.webp", "Fotografia protetta di una reinterpretazione Dragon Ball durante la lavorazione", 1200)],
    status: "da-documentare",
  },
  {
    id: "mucca-e-pollo",
    ...
    processImages: [wip("lw-wip-008-preview.webp", "Fotografia protetta della reinterpretazione di Mucca e Pollo durante la lavorazione")],
    status: "da-documentare",
  },
  {
    id: "ed-edd-eddy",
    ...
    processImages: [wip("lw-wip-009-preview.webp", "Fotografia protetta della reinterpretazione di Ed, Edd e Eddy durante la lavorazione")],
    status: "da-documentare",
  },
];
