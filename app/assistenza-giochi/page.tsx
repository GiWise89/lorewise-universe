...
export default function GameSupportPage() {
  return <main className="game-support-page">
    <header className="game-support-hero"><div className="shell"><Image src="/brand/icons/community-v2.webp" alt="Emblema illustrato dell’assistenza LoreWise" width={1224} height={1285} priority unoptimized /><div><p className="eyebrow">LoreWise Universe · assistenza GiWise Studio</p><h1>Ogni problema<br />ha una traccia.</h1><p>Dall’acquisto all’aggiornamento: una richiesta resta collegata al gioco, al LoreWise ID e all’ordine corretto.</p></div></div></header>
