...
export default async function CommunityModerationSimulationPage() {
  ...
  return <main className="community-admin-page">
    <header className="community-admin-hero"><div className="shell"><Image src="/brand/icons/community-v2.webp" alt="Emblema illustrato della Community LoreWise" width={1224} height={1285} priority unoptimized /><div><p className="eyebrow">LoreWise Universe · simulazione amministratore</p><h1>Proviamo ogni decisione.</h1><p>Uno scenario indipendente dall’account reale permette di verificare l’interfaccia di moderazione senza modificare utenti, commenti o segnalazioni autentiche.</p></div></div></header>
