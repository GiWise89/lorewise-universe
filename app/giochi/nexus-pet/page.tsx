...
export default function NexusPetGuidePage() {
  return <main className={styles.page}>
    ...
    <section className={`shell ${styles.intro}`} id="giochi-e-album">
      ...
      <GuideImage src="/famiglio/rebuild/progression/lunar-islands-v2.webp" alt="Mappa illustrata delle quattro tappe del Percorso" caption="Cura, gioco, spedizione e lotta: completa le quattro tappe nell’ordine che preferisci." />
