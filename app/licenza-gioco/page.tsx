...
export default function GameLicensePage() {
  return <main className="game-license-page">
    ...
    <div className="shell game-license-document">
      ...
      <section className="game-license-signature"><div><p className="eyebrow">Integrità di EXE e APK</p><h2>Nessun avviso nascosto.</h2><p>Firma, provenienza e stato di verifica saranno dichiarati prima dell’acquisto insieme a nome file, versione, dimensione e SHA-256. LoreWise non inviterà mai a disattivare SmartScreen, Defender, Play Protect o altri strumenti di sicurezza.</p></div><ul><li>Download solo dalla libreria LoreWise</li><li>SHA-256 pubblicato e verificabile</li><li>Scansione antivirus registrata</li><li>Assistenza collegata all’ordine</li></ul></section>
