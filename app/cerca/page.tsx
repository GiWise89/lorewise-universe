...
export default function SearchPage() {
  ...
  const items: GlobalSearchItem[] = [
    ...
    { type: "Diario", title: "Dove nascono i mondi", description: "Bozze, passioni e dietro le quinte di disegni e videogiochi.", href: "/dove-nascono-i-mondi", image: "/brand/icons/mondi-v2.webp", terms: "GiWise biografia hobby collezioni disegno tavoletta grafica codice sviluppo creativo" },
    ...
    { type: "Servizi", title: "Commissioni artistiche", description: "Ritratti, figure complete e opere narrative su richiesta.", href: "/commissioni", image: "/brand/icons/commissioni-v2.webp", terms: "preventivo disegno ritratto opera personalizzata" },
    ...
    { type: "Servizi", title: "Assistenza", description: "Supporto per account, ordini, giochi, download e commissioni.", href: "/assistenza-giochi", image: "/brand/icons/community-v2.webp", terms: "aiuto ticket rimborso download account ordine" },
  ];
