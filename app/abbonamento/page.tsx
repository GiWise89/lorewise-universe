...
const faq = [
  ...
  ["I giochi sono compresi?", "The Wound Remembers entrerà nel Pass quando la sua edizione scaricabile sarà approvata. La futura demo Android di Demon Match Three sarà gratuita per tutti; formula e prezzo dell’edizione completa non sono ancora annunciati."],
    ...
    <main className="pass-page">
      ...
      <section className="pass-chapter pass-chapter-games" id="giochi"><div className="shell">
        ...
        <div className="pass-game-stage">
          ...
          <article className="pass-game pass-game-demon"><Image className="pass-game-bg" src="/games/demon-match-three/gameplay-portal-backdrop-v1.webp" alt="Scenario fantasy con portale e griglia match-3 di Demon Match Three" fill sizes="(max-width: 900px) 100vw, 50vw" /><div className="pass-game-overlay" /><div className="pass-game-copy"><Image src="/games/demon-match-three/logo-official-v2.webp" alt="Demon Match Three" width={560} height={300} /><span>Android nativo · in pieno sviluppo</span><p>Segui lo sviluppo e le anteprime riservate nell’Area VIP. Demo gratuita Android in arrivo.</p></div></article>
        </div>
