...
export default async function ArtworkDeliveryAdminPage() {
  ...
  return <main className="delivery-admin-page">
    <header><div className="shell"><Image src="/brand/icons/arte-v2.webp" alt="Emblema Arte in Vetrina" width={1224} height={1285} unoptimized priority /><div><p className="eyebrow">GiWise Studio · Area privata</p><h1>Archivio<br />vendite Arte.</h1><p>Qui decidi quale pacchetto riceverà il cliente dopo un pagamento confermato. I file completi non entrano mai nella Vetrina pubblica.</p></div></div></header>
